...
<%
	Purchase pvo=(Purchase)request.getAttribute("purchase");
%>
...
<form name="updatePurchase" method="post"	action="/updatePurchase.do?tranNo=<%=pvo.getTranNo()%>">
	...
	<tr>
		...
		<td class="ct_write01">
			<input 	type="text" name="receiverName" 	class="ct_input_g" style="width: 100px; height: 19px" 
							maxLength="20" value="<%=pvo.getReceiverName() %>" />
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td class="ct_write01">
			<input 	type="text" name="receiverPhone" class="ct_input_g" style="width: 100px; height: 19px" 
							maxLength="20" value="<%=pvo.getReceiverPhone() %>" />
		</td>
	</tr>
	...
	<tr>
		...
		<td class="ct_write01">
			<input 	type="text" name="receiverAddr" class="ct_input_g" style="width: 100px; height: 19px" 
							maxLength="20" value="<%=pvo.getDivyAddr() %>" />
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td class="ct_write01">
			<input 	type="text" name="receiverRequest" 	class="ct_input_g" style="width: 100px; height: 19px" 
							maxLength="20" value="<%=pvo.getDivyRequest() %>" />
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
